...
float4 PS( VS_OUTPUT input ) : SV_Target
{
	...
	ComputePointLight(Mater, PntLight1, input.PosMS, normalize(input.Norm), msDirToEye, A, D, S);
   ...
   //     spec = 1;
    ...
    // return lerp(litColor, fogCol, FogPercent); // See https://msdn.microsoft.com/en-us/library/windows/desktop/bb509618(v=vs.85).aspx
    return litColor; // See https://msdn.microsoft.com/en-us/library/windows/desktop/bb509618(v=vs.85).aspx
